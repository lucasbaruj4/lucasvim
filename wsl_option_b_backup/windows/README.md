...
| `GlobalHotkeys.cs` | Useful system-wide hotkeys: Shift+S opens the normal Windows Snipping Tool, Ctrl+Alt+Up/Down changes volume, and Ctrl+Shift+M toggles mute. It does not intercept Windows-key shortcuts; Windows handles Alt+Tab and Alt+Space normally. |
...
| `windhawk/README.md` | Windhawk installation record. It has no active mods; no taskbar change has been applied. |
